L.TileLayer.WMTS = L.TileLayer.extend({
    ...
    getTileUrl: function (tilePoint, zoom) { // (Point, Number) -> String
        ...
        nw = crs.project(map.unproject(nwPoint, map.getZoom()));
        se = crs.project(map.unproject(sePoint, map.getZoom()));
        tilewidth = se.x-nw.x;
        zoom=map.getZoom();
    ...
    getDefaultMatrix : function () {
        ...
        for (var i= 0; i<22; i++) {
            matrixIds3857[i]= {
                ...
                //topLeftCorner : new L.LatLng(4565432.000000,207256.000000)
