(function (root, factory) {
	...
	L.TileLayer.Provider.providers = {
		...
		MapBox: {
			url: 'https://api.tiles.mapbox.com/v3/{id}/{z}/{x}/{y}.png?access_token={accessToken}',
			options: {
				attribution:
				...
				subdomains: 'abcd',
				id: 'streets',
				accessToken: 'pk.eyJ1IjoiY2FyY2FhcyIsImEiOiJjaW1pdGtrOGMwMDB0dmxtNTBxcmZiZzV5In0.hAfiGKNYOPaL9UdXS6ouXQ',
			}
		},
		Stamen: {
